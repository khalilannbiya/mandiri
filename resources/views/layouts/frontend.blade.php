...
<body class="font-rubik relative">
    {{-- Header --}}
    ...
    <main class="mx-auto px-4">
        ...
        <a href="https://api.whatsapp.com/send?phone=6281290959055&text=Halo,%20Saya%20tertarik%20dengan%20jasa%20percetakan%20yang%20Anda%20tawarkan.%20Saya%20ingin%20bertanya%20tentang..."
            aria-label="Hubungi kami melalui Whatsapp" target="_blank"
            class="bg-[#25d365c6] px-2 py-2 md:px-3 md:py-2  rounded-[50%] md:rounded-[20px] flex justify-between gap-2 items-center fixed bottom-8 md:bottom-6 right-4 z-[10]">
            ...
            <span class="text-white text-sm font-semibold hidden md:block">Hubungi Kami</span>
        </a>
